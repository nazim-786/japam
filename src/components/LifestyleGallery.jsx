...
<div className="max-w-[1400px] mx-auto px-4 md:px-6 lg:px-8 mt-4 mb-6">
  <h2 className="text-[42px] md:text-[48px] font-black leading-tight text-[#1F2340]">
  ...
  <img
    ...
    alt=""
    className="w-full h-[260px] sm:h-[290px] md:h-[340px] object-cover transition-all duration-700 ease-in-out hover:scale-[1.03]"
  />
</div>
